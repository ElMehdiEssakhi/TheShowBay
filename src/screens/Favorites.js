...
import {fetchFavorites } from "../firebase/services/firestoreService";
...
export default function FavoritesScreen({ navigation }) {
  ...
  const renderShowCard = ({ item }) => {
    if (!item.showPoster) return null;
    return (
      <TouchableOpacity
        style={styles.card}
      ...
      return (
        <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
                Shows you add to your favorites will appear here.
            </Text>
  ...
  if (!user) {
      return (
        <SafeAreaView style={[styles.container, styles.centerContainer]}>
             ...
             <Text style={styles.emptySubtitle}>You need an account to save a favorites list.</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        {!loading && (
            <Text style={styles.countText}>{favorites.length} Shows</Text>
        )}
      </View>
